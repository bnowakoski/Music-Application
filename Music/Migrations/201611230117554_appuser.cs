namespace Music.Migrations
{
    ...
    public partial class appuser : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Playlists", "Owner_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.PlaylistAlbums", "Playlist_PlaylistID", "dbo.Playlists");
            DropForeignKey("dbo.PlaylistAlbums", "AlbumID", "dbo.Albums");
            ...
            DropIndex("dbo.Playlists", new[] { "Owner_Id" });
            DropIndex("dbo.PlaylistAlbums", new[] { "Playlist_PlaylistID" });
            DropIndex("dbo.PlaylistAlbums", new[] { "AlbumID" });
